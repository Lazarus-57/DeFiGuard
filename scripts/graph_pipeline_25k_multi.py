"""25k multi-pattern graph pipeline.

Generates peel-chain AND smurfing synthetic transactions, merges them
with real 25k Ethereum data, and writes augmented CSVs + wallet features
to ``data/processed/25k/``.
"""
...
DATA_RAW_DIR = PROJECT_ROOT / "data" / "raw" / "25k"
DATA_PROCESSED_DIR = PROJECT_ROOT / "data" / "processed" / "25k"

SOURCE_FILE = DATA_RAW_DIR / "eth_transfers_25k_2024_final.csv"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build augmented 25k AML dataset with peel-chain AND smurfing patterns."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to raw source CSV. Defaults to data/raw/25k/eth_transfers_25k_2024_final.csv.",
    )
